    ...
    >
        <div className="relative xl:w-2/5 flex flex-col 
            justify-center items-start w-full max-xl:padding-x pt-28">
              ...
              Step into style: Where Every Stride Tells a story.Discover the Perfect pair for your journey!
              </p>
        ...
        <div className="flex sm:gap-6 gap-4 absolute sm:bottom-[79%] lg:bottom-[83%] sm:right-[10%] max-sm:px-6">
